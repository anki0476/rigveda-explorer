        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            <h3 className="text-xl font-[family:--font-family-header] text-[--color-ink] mb-3 flex items-center gap-2">
              🎙️ Mandala Specific Podcasts
            </h3>
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              20 immersive podcasts (10 English + 10 Hindi) covering all Mandalas, generated using AI with custom scripts. Each features conversational AI hosts exploring themes, 
              philosophy, and historical context with chapter navigation and transcripts.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Complete achievement system with 15+ unlockable badges, XP progression, deity collector mini-game 
              with 3D card flips, story mode with branching narratives, and progress tracking across all 
              features. Earn rewards by exploring content!
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Powered by Google Gemini AI, this conversational assistant answers questions about Vedic 
              philosophy, provides verse interpretations, explains Sanskrit terms, and offers personalized 
              wisdom with context-aware responses and markdown formatting.
            </p>
          </div>

          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            <h3 className="text-xl font-[family:--font-family-header] text-[--color-ink] mb-3 flex items-center gap-2">
              🕸️ Interactive Deity Network
            </h3>
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              D3.js force-directed graph visualizing {deities.deities.length} deities and {connections.connections.length} relationships. 
              Features dynamic physics, hover tooltips, filtering by domain, zoomable canvas, and detailed 
              deity profiles with mythology, symbols, and associated hymns.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Narrative-driven exploration with branching storylines, player choices affecting outcomes, 
              character-driven plots featuring sages and deities, and beautifully illustrated story cards. 
              Unlock new paths as you progress through Vedic tales.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Interactive celestial visualization of 8 Vedic constellations (Nakshatras) with animated stars, 
              constellation mythology, astrological significance, and connections to Rigvedic hymns. Features 
              smooth animations and educational tooltips.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              {topics.topics.length} comprehensive explorations connecting modern life challenges to Vedic wisdom—
              mind, health, ethics, purpose, relationships, and more. Each topic includes Sanskrit concepts, 
              practical applications, relevant hymns, and reflection questions.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              17 professionally narrated hymn audio files with Sanskrit recitation, ambient Vedic soundscapes 
              with fire crackling and chanting, custom sound effects for interactions (page flips, unlocks), 
              and toggleable background audio throughout the app.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Personality assessment matching users to Vedic archetypes based on philosophical alignment, 
              values, and life approach. Provides detailed profile descriptions, associated deities, 
              recommended practices, and personalized content suggestions.
            </p>
          </div>
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Random fact generator with {facts.facts.length} curated discoveries spanning linguistics, mythology, 
              philosophy, science connections, and cross-cultural influences. Features typewriter animation 
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Realistic page-turning experience with CSS 3D transforms, flip animations with sound effects, 
              ancient manuscript styling, and interactive navigation. Introduces Rigveda structure in an 
          ...
          <div className="bg-[--color-parchment-light] p-6 rounded-lg border-l-4 border-[--color-saffron]">
            ...
            <p className="text-[--color-ink-light] font-[family:--font-family-body] text-sm">
              Powerful search across all content types—deities, hymns, topics, facts, and Sanskrit terms. 
              Features real-time filtering, typewriter placeholder animations, category-based results, 
