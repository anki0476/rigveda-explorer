...
const GamesHub = () => {
  ...
  return (
    <>
      {/* Rishi Welcome Popup */}
      <RishiWelcome
        image="/images/rishi-mascot-games.png"
        dialogue="Play StoryMode inspired by the events of RigVeda while collecting collectible Deity Cards and unlocking achievements!!"
        storageKey="gamesHubWelcome"
      />
