...
const SurpriseMe = () => {
  ...
  return (
    <>
      {/* Rishi Welcome Popup */}
      <RishiWelcome
        image="/images/rishi-mascot-surprise-me.png"
        dialogue="Come discover some of the most interesting facts about the RigVeda that will leave you shocked and curios at the same time!!!"
        storageKey="surpriseMeWelcome"
      />
