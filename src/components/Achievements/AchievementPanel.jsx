...
const AchievementPanel = () => {
  ...
  const unlockedCount = progress.achievements?.length || 0; // ✅ CHANGE 1: Fixed from unlockedAchievements to achievements
          ...
          <div key={tier} className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {tierAchievements.map(achievement => {
                const isUnlocked = progress.achievements?.includes(achievement.id); // ✅ CHANGE 2: Fixed from unlockedAchievements to achievements
